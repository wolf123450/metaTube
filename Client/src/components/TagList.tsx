...
const TagList: React.FC<TagListProps> = ({ tagList, tagListChanged, canDelete, sx }) => {
    const [newTagValue, setNewTagValue] = React.useState("");

    const newTagValueChanged: React.ChangeEventHandler = (event) => { setNewTagValue((event.target as HTMLTextAreaElement).value) }
